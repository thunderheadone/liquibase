...
public class LiquibaseDatabaseDiff extends AbstractLiquibaseChangeLogMojo {
    ...
    protected void performLiquibaseTask(Liquibase liquibase) throws LiquibaseException {
        ...
        Database referenceDatabase = CommandLineUtils.createDatabaseObject(fileOpener, referenceUrl, referenceUsername, referencePassword, referenceDriver, referenceDefaultCatalogName, referenceDefaultSchemaName, outputDefaultCatalog, outputDefaultSchema, null, null, null, propertyProviderClass, null, null, databaseChangeLogTableName, databaseChangeLogLockTableName);
